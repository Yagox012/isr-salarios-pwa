...
export default function Ajustes() {
  ...
  const sections = [
    /* Apariencia */
    <section key="apariencia" className={`spring-enter ${glassCard}`} style={{ animationDelay: '0.04s' }}>
    ...
    /* Cifras fiscales */
    <section key="cifras" className={`spring-enter ${glassCard}`} style={{ animationDelay: '0.10s' }}>
    ...
    /* Progreso */
    <section key="progreso" className={`spring-enter ${glassCard}`} style={{ animationDelay: '0.16s' }}>
      <h2 className="text-sm font-bold text-slate-800 dark:text-slate-100">Progreso</h2>
      <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
        Borra el avance de todos los temas. No se puede deshacer.
      </p>
      {!confirmando ? (
        <SpringCard
          as="button"
    ...
    /* Acerca de */
    <section key="acerca" className={`spring-enter ${glassCard}`} style={{ animationDelay: '0.22s' }}>
